...
<head>
  ...
  <title>ずんだまんじゅう | 商品のご案内</title>
  <meta name="description" content="厳選された枝豆を惜しみなく使った、香り高いずんだ餡を舌触りの良い生地で包みました。 定禅寺通りのけやき並木で、風に心地よく揺られる葉をモチーフに考えられた、けやきまるの代表作です。ちょっとした手土産にちょうど良いサイズ感です。">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="format-detection" content="telephone=no">

  <!-- ############ ogp ########### -->
  <meta property="og:title" content="ずんだまんじゅう | 商品のご案内" />
  ...
  <meta property="og:site_name" content="ずんだまんじゅう | 商品のご案内" />
  <meta property="og:description" content="厳選された枝豆を惜しみなく使った、香り高いずんだ餡を舌触りの良い生地で包みました。 定禅寺通りのけやき並木で、風に心地よく揺られる葉をモチーフに考えられた、けやきまるの代表作です。ちょっとした手土産にちょうど良いサイズ感です。" />
...
<body class="top">
  ...
  <main>
    <div class="section-inner">
      <div class="menu">
        <div class="menuimg">
          <img src="../images/products/zunda.jpg" alt="">
        </div>
        <div class="menuread">
          <h2>ずんだまんじゅう</h2>
          <p>厳選された枝豆を惜しみなく使った、香り高いずんだ餡を舌触りの良い生地で包みました。 定禅寺通りのけやき並木で、風に心地よく揺られる葉をモチーフに考えられた、けやきまるの代表作です。ちょっとした手土産にちょうど良いサイズ感です。</p>
            <table>
              <tr>
                <th>1個</th>
                <td>140円</td>
