...
<head>
  ...
  <title>すずめ | 商品のご案内</title>
  <meta name="description" content="栗の甘さを活かした栗あんをバランスよく包んだ、けやきまるの定番商品です。かわいらしい色合いから、けやきの木陰で休むすずめたちをイメージさせます。スタッフからも人気の高い自信作です。">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="format-detection" content="telephone=no">

  <!-- ############ ogp ########### -->
  <meta property="og:title" content="すずめ | 商品のご案内" />
  ...
  <meta property="og:site_name" content="すずめ | 商品のご案内" />
  <meta property="og:description" content="栗の甘さを活かした栗あんをバランスよく包んだ、けやきまるの定番商品です。かわいらしい色合いから、けやきの木陰で休むすずめたちをイメージさせます。スタッフからも人気の高い自信作です。" />
...
<body class="top">
  ...
  <main>
    <div class="section-inner">
      <div class="menu">
        <div class="menuimg">
          <img src="../images/products/suzume.jpg" alt="">
        </div>
        <div class="menuread">
          <h2>すずめ</h2>
          <p>栗の甘さを活かした栗あんをバランスよく包んだ、けやきまるの定番商品です。かわいらしい色合いから、けやきの木陰で休むすずめたちをイメージさせます。スタッフからも人気の高い自信作です。</p>
            <table>
              <tr>
                <th>1個</th>
                <td>140円</td>
